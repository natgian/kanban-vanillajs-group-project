      ...
      <div class="content-top">
        ...
        <div class="contact-details">
          ...
          <div class="mobile-dropdown-wrapper">
            <div id="mobile-dropdown-button" onclick="toggleDropdown('${id}', event)">
...
function templateNewContact() {
  return `
      <div id="popup">
        <div id="popupCloseBtn" class="popup-close">
        ...
        <div class="popup-right">
          ...
          <form onsubmit="createNewContact(event)" novalidate>
            <div class="form-control">
              <div class="input-container">
                <input required type="text" id="name" placeholder="Name">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M480-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM160-160v-112q0-34 17.5-62.5T224-378q62-31 126-46.5T480-440q66 0 130 15.5T736-378q29 15 46.5 43.5T800-272v112H160Zm80-80h480v-32q0-11-5.5-20T700-306q-54-27-109-40.5T480-360q-56 0-111 13.5T260-306q-9 5-14.5 14t-5.5 20v32Zm240-320q33 0 56.5-23.5T560-640q0-33-23.5-56.5T480-720q-33 0-56.5 23.5T400-640q0 33 23.5 56.5T480-560Zm0-80Zm0 400Z"/></svg>
              </div>
              <small class="validation d_none" id="name-validation">Please enter your full name (first and last).</small>
            </div>
            <div class="form-control">
              <div class="input-container">
              ...
              <small class="validation d_none" id="email-validation">Please enter a valid email address.</small>
            </div>
            <div class="form-control">
              <div class="input-container">
              ...
              <small class="validation d_none" id="phone-validation">Please enter a valid phone number in international format (e.g. +491701234567).</small>
            </div>
            <div class="create-buttons-div">
              <button class="first-button popup-btn-hov:hover" type="reset">Cancel <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></button>
              <button type="submit" class="btn">Create Contact<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF"><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg></button>
            </div>
          </form>
        </div>
      </div>`;
  ...
  return `
      <div id="popup" class="active-contact">
        ...
        <div class="popup-right">
          ...
          <form onsubmit="updateContact(event, '${id}')" novalidate>
            <div class="form-control">
              <div class="input-container">
            ...
            <div class="create-buttons-div">
              ...
              <button id="save" type="submit" class="btn" >Save<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF"><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg></button>
            </div>
          </form>
        </div>
      </div>`;
