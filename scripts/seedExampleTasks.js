...
const tasks = [
  {
    ...
    priority: "low",
    assignedTo: [
      { name: "Anna Müller", initials: "AM", color: "#FFC0CB" },
      { name: "Isabel Lange", initials: "IL", color: "#A52A2A" },
      { name: "Claudia Thiel", initials: "CT", color: "#A52A2A" },
    ],
  ...
  },
  {
    ...
    dueDate: "25/05/2025",
    priority: "low",
    assignedTo: [{ name: "Claudia Thiel", initials: "CT", color: "#A52A2A" }],
    category: "Technical Task",
    subtasks: [],
  },
  {
